...
I work as a Senior Research Scientist and Professor at SnT — the Interdisciplinary Research Centre on Security, Reliability and Trust (SnT) of the University of Luxembourg. My research activities currently focuses on artificial intelligence (in particular, trustworthy and secure machine learning) and I also have a strong background in software engineering. I am deputy head and one of the four permanent scientists of SnT’s SeRVal group (Security, Reasoning and Validation, 60+ members), in which I lead a team of 20+ researchers working on AI. 
...
My research is inspired from and applies to several industry partners in various domains such as finance, energy, public services, cybersecurity and space. I am deeply engaged in technology transfer and collaborative research with the industry, e.g. through the creation of spin-off companies and the leadership of private-public partnership projects at SnT.

I am leading the R&D activities of SnT in Luxembourg's AI Factory project, a large initiative to foster AI innovation in the country. In this project, I am responsible for developing the AI Sandbox Configurator — an open-source tool that enables organisations to design and deploy customised, on-premises AI assessment sandboxes for evaluating the performance, trustworthiness, and compliance of their AI systems with EU regulations.
